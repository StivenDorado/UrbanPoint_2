...
<<<<<<< HEAD
    <div>
      <h2>Registro</h2>
      {/* Agrega el formulario de registro u otro contenido necesario */}
=======
    <div className="flex flex-col items-center justify-center h-screen">
      <div className="space-y-4">
        ...
        <form class="rounded-md rounded-md min-w-full space-y-5">
          {/* Selecciona país */}
          ...
          <button class="flex  mx-auto bg-gray-600">Registrarse</button>
        </form>
        <br />
        ...
        <h2 className='text-2xl text-center font-bold'>Hola!</h2>
          <br />
          <button class="flex mx-auto bg-gray-600">Inicia Sesion</button>
        </div>
      </div>
>>>>>>> stiven
    </div>
