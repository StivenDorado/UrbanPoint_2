    ...
    <div className="flex flex-col items-center justify-center h-screen">
      <div className="space-y-4">
        ...
        <div className="flex gap-4 items-center justify-center">
          <img src="../../../public/BxBxlGmail.svg" width="50" alt="Gmail" className="mx-auto" />
          <img src="../../../public/MdiFacebook.svg" width="45" alt="Facebook" className="mx-auto" />
          <img src="../../../public/LogosApple.svg" width="33" alt="Apple" className="mx-auto" />
        </div>
      </div>
      ...
      <form className="rounded-md min-w-full space-y-5">
        ...
        <div className="relative w-full">
          ...
          <select id="country" className="w-full pl-10 h-10 rounded-md border border-gray-300 focus:ring focus:ring-blue-500">
        ...
        <button className="flex mx-auto bg-gray-600 text-white py-2 px-4 rounded-md">Registrarse</button>
      </form>
      <br />
      
      {/* Botones circulares */}
      <div>
        <h2 className="text-2xl text-center font-bold">Hola!</h2>
        <br />
        <button className="flex mx-auto bg-gray-600 text-white py-2 px-4 rounded-md">Inicia Sesión</button>
      </div>
    </div>
  );
}
