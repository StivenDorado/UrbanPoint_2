export default function Component() {
    return (
      <article className="flex items-center min-h-screen">
        <article className="grid gap-4 md:gap-10 order-2 md:order-1 mx-auto rounded-lg border border-radius px-6 py-4">
                ...
                <article className="flex gap-2">
                  <article className="relative">
                    <button className="border border-gray-300 rounded-lg px-1 py-2 text-left">
                      <span className="font-semibold uppercase px-2 py-1 text-[0.65rem]">Entrada</span>
                      <span className="font-normal px-2 py-1">4/2/2024</span>
                    </button>
                  ...
                  <article className="relative">
                    <button className="border border-gray-300 rounded-lg px-1 py-2 w-full text-left">
                      <span className="font-semibold uppercase text-[0.65rem] px-2 py-1">Salida</span>
                      <span className="font-normal px-2 py-1">10/2/2024</span>
                    </button>
                    {/* Contenido del popover (Calendar) se omite en HTML estándar */}
                  </article>
                </article>
