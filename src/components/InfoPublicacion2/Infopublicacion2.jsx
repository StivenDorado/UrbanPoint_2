/**
 * v0 by Vercel.
 * @see https://v0.dev/t/gGWCMfNbYpa
      ...
      <article className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <article>
          ...
          <ul className="space-y-2">
            ...
            <li className="flex items-center gap-2">
              <GlassWaterIcon className="w-5 h-5 text-primary" />
              Agua
            </li>
            <li className="flex items-center gap-2">
            ...
            <li className="flex items-center gap-2">
              <CookingPotIcon className="w-5 h-5 text-primary" />
              Cocina en las habitaciones
            </li>
            <li className="flex items-center gap-2">
            ...
            <li className="flex items-center gap-2">
              <TreesIcon className="w-5 h-5 text-primary" />
              Terraza
            </li>
          </ul>
        </article>
        <article>
          <h2 className="text-2xl font-bold mb-4">Reglas de alojamiento</h2>
          <ul className="space-y-2">
            <li className="flex items-center gap-2">
              <ClockIcon className="w-5 h-5 text-primary" />
              Hora de llegada a las 10 PM
            </li>
            <li className="flex items-center gap-2">
              <CigaretteIcon className="w-5 h-5 text-primary" />
